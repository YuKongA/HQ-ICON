! function(e) {
    ...
    function(_e, t, n) {
        ...
        n(85);
        var g = function(e) {
            function t(e) { i(this, t); var n = a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)); return n.state = { input: "", results: [], country: "CN", resolution: 1024 }, n.search = n.search.bind(n), n }
            return u(t, e), l(t, [{
                key: "search",
                value: function() {
                ...
                value: function() {
                    var e = this,
                        ...
                        o = t.country,
                        i = t.resolution;
                    return d.default.createElement("div", { className: "app" }, d.default.createElement("header", null, d.default.createElement("div", { className: "center" }, d.default.createElement("div", { className: "logo" }, "HQ ICON"), d.default.createElement("div", { className: "description" }, "获取高质量应用图标"), d.default.createElement("div", { className: "options" }, "国家: ", d.default.createElement("lable", { onClick: function() { return e.setState({ country: "CN" }) } }, d.default.createElement("input", { name: "store", type: "radio", checked: "CN" === o }), "中国"), d.default.createElement("lable", { onClick: function() { return e.setState({ country: "US" }) } }, d.default.createElement("input", { name: "store", type: "radio", checked: "US" === o }), "美国"), d.default.createElement("lable", { onClick: function() { return e.setState({ country: "JP" }) } }, d.default.createElement("input", { name: "store", type: "radio", checked: "JP" === o }), "日本")), d.default.createElement("div", { className: "options" }, "分辨率: ", d.default.createElement("lable", { onClick: function() { return e.setState({ resolution: 512 }) } }, d.default.createElement("input", {
                        name: "resolution",
                        type: "radio",
                        checked: 512 === i
                    }), "512x512"), d.default.createElement("lable", { onClick: function() { return e.setState({ resolution: 1024 }) } }, d.default.createElement("input", { name: "resolution", type: "radio", checked: 1024 === i }), "1024x1024")), d.default.createElement("div", { className: "search" }, d.default.createElement("input", { className: "search-input", placeholder: "应用名称 / iTunes链接", value: n, onChange: function(t) { return e.setState({ input: t.target.value }) }, onKeyDown: function(t) { return 13 === t.keyCode ? e.search() : "" } }), d.default.createElement("div", { className: "search-button", onClick: this.search }, d.default.createElement("img", { src: y.default, className: "search-icon", alt: "search" }))))), d.default.createElement("main", { className: "results" }, r.map(function(e) { return d.default.createElement(h.default, { key: e.trackId, data: e, resolution: i }) })), d.default.createElement("footer", { className: "footer" }, "Copyrights © 2021 - 浙ICP备2021010095号", ))
                }
            }]), t
        }(p.Component);
        t.default = g
    ...
    function(_e, t, n) {
        ...
        function i(e) { var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "US"; return (0, c.default)("https: //itunes.apple.com/lookup?id=" + e + "&country=" + t).then(function(e) { return e.json() }) }
    ...
    function(e, _t, n) { e.exports = n.p + "static/media/search.svg" },
    function(e, _t, n) {
        "use strict";
